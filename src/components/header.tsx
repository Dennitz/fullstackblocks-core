...
export const Header: React.FC<{ authenticated?: boolean }> = (props = { authenticated: false }) => (
  <nav className="mx-auto flex max-w-7xl py-6 px-10 flex-col md:flex-row space-y-5 md:space-y-0">
    ...
    <HeaderLink href="/client-side-protected" className="md:ml-10">
      Protected (client-side)
    </HeaderLink>
    <HeaderLink href="/server-side-protected" className="md:ml-10">
      Protected (server-side)
    </HeaderLink>
    <HeaderLink href="/app/middleware-protected" className="md:ml-10">
